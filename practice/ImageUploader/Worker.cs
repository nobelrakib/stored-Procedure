    ...
    public class Worker : BackgroundService
    {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            while (!stoppingToken.IsCancellationRequested)
            {
                ...
                var sqsResponse = await sqsClient.ReceiveMessageAsync("	https://sqs.us-east-1.amazonaws.com/847888492411/rakib01");
                if (sqsResponse.HttpStatusCode == System.Net.HttpStatusCode.OK)
                {
                    foreach (var message in sqsResponse.Messages)
                    {
                        ...
                        var deleteQueueItemRequest = new DeleteMessageRequest("	https://sqs.us-east-1.amazonaws.com/847888492411/rakib01", message.ReceiptHandle);
                        ...
                        await dbHelper.Insert(new DynamoInsertItem
                        {
                            TableName = "test",
